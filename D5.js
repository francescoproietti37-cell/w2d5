...
- Utilizzaaaaaaaaaaaa dei console.log() per testare le tue variabili e/o i risultati delle espressioni che stai creando.
*/
...
*/
for (let i = 0; i < cars.length; i++) {
  let prima = cars[i].color.charAt(0)
